...
export default function SkillsToLearnScreen({ navigation }) {
  ...
  const onNextPressed = async () => {
    try {
      ...
      await setDoc(userDocRef, { skillsToLearn: selectedSkills }, { merge: true });
  ...
  return (
    <LinearGradient colors={["#eef2f3", "#8e9eab"]} style={styles.gradientContainer}>
      <View style={styles.header}>
        <Text style={styles.title}>What would you love to learn?</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 25.8, fontWeight: "700", color: "#2b3a67", marginBottom: 6 },
